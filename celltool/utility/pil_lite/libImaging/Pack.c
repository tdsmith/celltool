...
static void
packI16(UINT8* out, const UINT8* in_, int pixels)
{
    int i;
    INT32* in = (INT32*) in_;
    UINT16 tmp_;
...
static void
packSI16B(UINT8* out, const UINT8* in, int pixels)
{
    int i;
    const UINT8* tmp = in;
    for (i = 0; i < pixels; i++) {
...
static void
packSI16(UINT8* out, const UINT8* in, int pixels)
{
    int i;
    const UINT8* tmp = in;
    for (i = 0; i < pixels; i++) {
