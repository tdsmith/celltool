...
fitpack_insert(PyObject *dummy, PyObject*args)
{
    ...
    ap_t_in = (PyArrayObject *)PyArray_ContiguousFromObject(t_py, PyArray_DOUBLE, 0, 1);
    ap_c_in = (PyArrayObject *)PyArray_ContiguousFromObject(c_py, PyArray_DOUBLE, 0, 1);
    ...
    nest = n + m;
    dims[0] = nest;
    ap_t_out = (PyArrayObject *)PyArray_SimpleNew(1, dims, PyArray_DOUBLE);
    ap_c_out = (PyArrayObject *)PyArray_SimpleNew(1, dims, PyArray_DOUBLE);
